                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" method="post" action="<%=request.getContextPath()%>/auth/login">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                            <input class="input100" type="text" name="username" value="Admin" placeholder="Tên tài khoản">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Password is required">
                            <input class="input100" type="password" name="pass" value="123" placeholder="Mật khẩu">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
